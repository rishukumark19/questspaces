      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="font-body-md text-body-md text-on-surface mb-6 text-sm">
              Questspaces Pvt Ltd is a premier real estate advisory firm dedicated to empowering homebuyers and investors with transparent, research-backed guidance across Bengaluru.
            </p>
            <div className="flex gap-3">
              {/* Facebook */}
              <a href="https://facebook.com/questspacespvt.ltd/" target="_blank" rel="noreferrer" aria-label="Follow QuestSpaces on Facebook" className="w-9 h-9 rounded-full bg-surface-container-low flex items-center justify-center text-primary hover:bg-black hover:text-white transition-colors">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* Instagram */}
              <a href="https://instagram.com/questspaces/" target="_blank" rel="noreferrer" aria-label="Follow QuestSpaces on Instagram" className="w-9 h-9 rounded-full bg-surface-container-low flex items-center justify-center text-primary hover:bg-black hover:text-white transition-colors">
               ...
               {/* LinkedIn */}
               <a href="https://linkedin.com/company/questspaces-private-limited/" target="_blank" rel="noreferrer" aria-label="Follow QuestSpaces on LinkedIn" className="w-9 h-9 rounded-full bg-surface-container-low flex items-center justify-center text-primary hover:bg-black hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4 font-body-md text-sm text-on-surface-variant">
              ...
              <div className="flex gap-2">
                ...
                <span>+91 74117 36908</span>
              </div>
              <div className="flex gap-2">
                <Mail size={16} className="text-secondary shrink-0" />
                <span>info@questspaces.in</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-outline-variant/30 pt-6 flex justify-between items-center flex-wrap gap-4 font-body-md text-xs text-on-surface-variant">
          <div>
            © 2024-{new Date().getFullYear()} Questspaces Pvt Ltd. All Rights Reserved.
          </div>
