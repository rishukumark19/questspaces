  ...
  return (
    <div className="bg-background text-on-surface font-body-md antialiased">
      ...
      <section className="relative h-[450px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Quest Spaces Office Interior" 
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <div className="pt-8 border-t border-outline-variant/30">
              ...
              <div className="flex gap-3">
                <a href="https://facebook.com/questspacespvt.ltd/" target="_blank" rel="noreferrer" aria-label="Follow Quest Spaces on Facebook" className="w-10 h-10 border border-outline-variant/50 rounded-full flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all shadow-sm">
                  <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://instagram.com/questspaces/" target="_blank" rel="noreferrer" aria-label="Follow Quest Spaces on Instagram" className="w-10 h-10 border border-outline-variant/50 rounded-full flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all shadow-sm">
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="font-body-md text-sm text-on-surface-variant">
                    Thank you, <strong>{formData.name}</strong>. A Quest Spaces Senior Advisor will reach out to you at <strong>{formData.email}</strong> / <strong>{formData.phone}</strong> shortly.
                  </p>
                  <button 
      ...
      <section className="w-full h-[480px] relative border-t border-b border-outline-variant/30">
        <iframe 
          title="Quest Spaces Headquarters Location"
